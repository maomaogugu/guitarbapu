"""Sweep max_polyphony and report best."""
...
def main():
    ...
    for mp in (4, 3, 2, 5, 6):
        ...
        print(f"max_polyphony={mp}: strict={rep['recall']} midi={rep['midi_recall']} seq={rep['sequence_recall']} notes={rep['notes']} offset={rep['offset_seconds']}")
